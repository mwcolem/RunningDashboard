    ...
    <table className="w-full text-xs text-gray-600 border-t border-gray-100">
      <thead>
        <tr className="text-gray-400 text-left">
          ...
          <th className="px-4 py-2 font-medium">Dist (mi)</th>
          <th className="px-4 py-2 font-medium">Pace /mi</th>
      ...
      <tbody>
        {laps.map((lap, i) => (
          <tr key={i} className="border-t border-gray-50 hover:bg-gray-50">
            ...
            <td className="px-4 py-1.5">{((lap.distance ?? 0) / 1609.344).toFixed(2)}</td>
